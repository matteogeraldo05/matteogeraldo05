...
window.onload = function() {
    ...
    const audioElements = {
        ...
        genericKeyPress1: new Audio("audio/press/GENERIC_R1.mp3"),
        genericKeyPress2: new Audio("audio/press/GENERIC_R2.mp3"),
        genericKeyPress3: new Audio("audio/press/GENERIC_R3.mp3"),
        genericKeyPress4: new Audio("audio/press/GENERIC_R4.mp3"),
